...
bool DiskId::get_disk_name(std::string &disk_name)
{
    disk_name.c_str();
...
void DiskId::trim_serial(const void *serial, size_t serial_len, std::string &serial_no)
{
...
bool DiskId::get_disk_serial_by_way_1(const std::string &disk_name, std::string &serial_no)
{
    serial_no.clear();
...
bool DiskId::scsi_io(int fd, unsigned char *cdb, unsigned char cdb_size, int xfer_dir, unsigned char *data, unsigned int data_size, unsigned char *sense, unsigned int sense_len)
{
...
bool DiskId::get_disk_serial_by_way_2(const std::string &disk_name, std::string &serial_no)
{
    serial_no.clear();
...
bool DiskId::parse_serial(const char *line, int line_size, const char *match_words, std::string &serial_no)
{
...
void DiskId::get_serial(const char *file_name, const char *match_words, std::string &serial_no)
{
    serial_no.c_str();
...
bool DiskId::get_disk_serial_by_way_3(const std::string &disk_name, std::string &serial_no)
{
    serial_no.c_str();
...
bool DiskId::get_disk_serial_by_way_4(std::string &serial_no)
{
    serial_no.c_str();
...
bool DiskId::get_disk_serial_number(std::string &serial_no)
{
    if (0 != getuid())
    {
        return(false);
