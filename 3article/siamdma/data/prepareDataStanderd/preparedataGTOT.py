...
# inpath  = '/media/secret/data/hfc/DATA/TEST/RGB-T234'
# outpath = '/media/secret/data/hfc/DATA//TRAIN/DB/RGBT234'  

inpath  = '/opt/data/private/data/GTOT'
outpath = '/opt/data/private/data/DB/gtot'  
map_size = int(5e9)
